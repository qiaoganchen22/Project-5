...
{
   Node<T>* orig_chain_pointer = a_list.head_ptr_;  // Points to nodes in the original chain
   ...
   else
   {
      ...
      Node<T>* new_chain_ptr = head_ptr_;      // Points to the last node in new chain
      orig_chain_pointer = orig_chain_pointer->getNext();     // Advance the original-chain pointer
      while (orig_chain_pointer != nullptr)
      {
         // Get the next item from original chain
